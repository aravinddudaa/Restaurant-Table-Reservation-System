        ...
        <div class="container" style="border: violet;" id="table">
            <form style="background-color: aqua;" onsubmit="return validate()" action="order12.php">
              ...
              <div class="col-sm-6">
                  ...
                  <input type="radio" id="123" name="abc" value=1> 1
                  <input type="radio" id="123" name="abc" value=2> 2
                  <input type="radio" id="123" name="abc" value=3> 3
                  <input type="radio" id="123" name="abc" value=4> 4
                  <input type="radio" id="123" name="abc" value=5> 5
                  <input type="radio" id="123" name="abc" value=6> 6
                  <input type="radio" id="123" name="abc" value=7> 7
                  <input type="radio" id="123" name="abc" value=8> 8
              </div>
              </div>
              <br>
              <div class="row">
